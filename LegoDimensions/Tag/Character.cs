...
namespace LegoDimensions.Tag
{
    ...
    public class Character : ILegoTag
    {
        ...
        public static readonly List<Character> Characters = new List<Character>()
        {
            ...
            new Character(29, "Leoglas"             , "Lord of the Rings",     new List<string>() { "Pole Vault","Target","Acrobat","Grind Rails" }),
            ...
            new Character(72, "Betelgeuse"          , "Beetlejuice",           new List<string>() { "Mind Control","Magic","Slurp Access","Illumination","Mini Access","Super Strength","Apparate Access" }),
