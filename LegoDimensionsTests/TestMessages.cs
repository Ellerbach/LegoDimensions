...
namespace LegoDimensionsTests
{
    public class TestMessages
    {
        ...
        public void TestCreateFromMessage()
        {
            // Arrange
            // Act
            var message = Message.CreateFromBuffer(new byte[] { 0x55, 0x0f, 0xb0, 0x01, 0x28, 0x63, 0x29, 0x20, 0x4c, 0x45, 0x47, 0x4f, 0x20, 0x32, 0x30, 0x31, 0x34, 0xf7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, MessageSource.Machine);
        ...
        public void TestReceived()
        {
            // Arrange
            // Act
            var message = Message.CreateFromBuffer(new byte[] { 0x55, 0x01, 0x03, 0x59, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, MessageSource.Portal);
        ...
        public void TestReceivedInput()
        {
            // Arrange
            // Act
            var message = Message.CreateFromBuffer(new byte[] { 0x55, 0x12, 0x03, 0x00, 0xBC, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, MessageSource.Portal);
